// Builds the Arcane Quest (RPG) ThemeData (see the function doc below);
// attaches Getman's eight theme extensions via ThemeData.copyWith.
...
ThemeData rpgTheme(
  ...
  return base.copyWith(
    extensions: [
      ...
      rpgComponents(reduceEffects: reduceEffects),
    ],
  );
}
