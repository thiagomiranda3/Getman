...
// core/error/guard.dart + docs/architecture/app-shell.md):
// PersistenceException (Hive I/O failures), FileBodyException (a multipart
// file row / binary body whose path can't be read at send time), and
// GraphqlVariablesException (the GraphQL VARIABLES pane holds invalid JSON).
// All are pure Dart (no dart:io) so they can cross the data -> network
// boundary; repositories translate them into typed Failure subtypes before a
// BLoC ever sees them.
