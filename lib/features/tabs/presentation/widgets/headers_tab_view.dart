...
// (split view) and UnifiedRequestPanel (phone). The Content-Type row is
// seeded by the entity default and rewritten by the BODY tab's selector
// (HttpRequestConfigEntity.withBodyType) — this view never touches it
// itself. Below the editor, AutoGeneratedHeadersSection lists what the
// client adds at send time (Postman's "auto-generated headers").
//
      ...
      builder: (context, state) {
        ...
        return Column(
          ...
          children: [
            ...
            // What the client adds on top of the rows above (own BlocBuilder:
            // it also reacts to body-type/auth changes this builder ignores).
            AutoGeneratedHeadersSection(tabId: tabId),
          ],
        );
      },
    );
