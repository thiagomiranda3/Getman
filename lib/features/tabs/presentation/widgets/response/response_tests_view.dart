...
class ResponseTestsView extends StatelessWidget {
  const ResponseTestsView({required this.tabId, super.key});
  final String tabId;
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Icon(
            a.passed ? Icons.check_circle_outline : Icons.cancel_outlined,
            color: color,
  ...
  Widget _extractionRow(BuildContext context, ExtractionResult e) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Icon(
            e.matched ? Icons.download_done : Icons.search_off,
            color: color,
