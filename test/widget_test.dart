...
void main() {
  testWidgets(
    'MethodBadge renders every supported HTTP method without crashing',
    (tester) async {
  ...
  testWidgets('MethodBadge uses the palette-driven method color', (
    tester,
  ) async {
  ...
  testWidgets('MethodBadge renders in both compact and normal layouts', (
    tester,
  ) async {
    await tester.pumpWidget(
      _wrap(const MethodBadge(method: 'POST'), compact: true),
    );
  ...
  testWidgets('MethodBadge renders in dark theme', (tester) async {
    await tester.pumpWidget(
      _wrap(const MethodBadge(method: 'DELETE'), dark: true),
    );
