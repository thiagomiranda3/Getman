...
void main() {
  ...
  testWidgets('first frame renders the auto-generated headers section', (
    tester,
  ) async {
    await pumpHeadersTab(tester);
    expect(find.byType(AutoGeneratedHeadersSection), findsOneWidget);
    expect(find.textContaining('AUTO-GENERATED HEADERS'), findsOneWidget);
  });
}
