...
import 'flows/collections_context_menu_test.dart' as collections_context_menu;
...
import 'flows/history_management_test.dart' as history_management;
import 'flows/history_test.dart' as history;
import 'flows/json_fold_test.dart' as json_fold;
import 'flows/mcp_test.dart' as mcp;
import 'flows/open_tabs_dropdown_test.dart' as open_tabs_dropdown;
...
import 'flows/response_media_test.dart' as response_media;
...
import 'flows/shortcuts_help_test.dart' as shortcuts_help;
...
import 'flows/tab_strip_double_click_test.dart' as tab_strip_double_click;
...
import 'flows/tree_search_collapse_test.dart' as tree_search_collapse;
import 'flows/unresolved_vars_chip_test.dart' as unresolved_vars_chip;
import 'flows/url_enter_to_send_test.dart' as url_enter_to_send;
...
void main() {
  ...
  tab_management.main();
  tab_shortcuts.main();
  tab_strip_double_click.main();
  open_tabs_dropdown.main();
  panels.main();
  request_config.main();
  request_config_deep.main();
  body_types.main();
  url_enter_to_send.main();
  unresolved_vars_chip.main();
  history.main();
  history_deep.main();
  history_management.main();
  collections.main();
  collections_deep.main();
  collections_context_menu.main();
  tree_search_collapse.main();
  saved_examples.main();
  environments.main();
